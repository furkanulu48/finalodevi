...
public class main /* main sınıfımız oluşturuldu */{
    ...
    /* Görüldüğü üzre ulaşamıyoruz. Sebebi ise Ogrenci classındaki erişim belirleyicilerinin private oluşu.
           Biz herkesin dışarıdan ulaşmamasını istediğimizi farz edelim. Bu sebeble getter ve setter metodlarını
           kullanacağız.*/ 
